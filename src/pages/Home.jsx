      ...
      <section className="relative min-h-screen flex items-center justify-center px-4" style={{ background: "radial-gradient(ellipse 80% 60% at 50% 50%, #0a1628 0%, #020408 100%)" }}>
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <p className="text-slate-500 text-sm max-w-xl mx-auto leading-relaxed">
            Most creators don't have a growth problem. They have a system problem. AltCtrl gives solo gaming creators the structure, promo support, coaching, and analytics they need to grow consistently — without an agency.
          </p>
        </div>
