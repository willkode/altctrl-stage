...
const TAM_DATA = [
  { label: "TAM", value: "$12.0B", desc: "50M creators × $20/mo × 12", color: "cyan", width: "100%" },
...
const SOM_SCENARIOS = [
  { creators: "10K", arpu: "$33", arr: "$3.96M" },
  { creators: "25K", arpu: "$33", arr: "$9.90M" },
  { creators: "50K", arpu: "$35", arr: "$21.0M" },
  { creators: "100K", arpu: "$35", arr: "$42.0M" },
];
  ...
  return (
    <section className="py-20 px-4 border-t border-cyan-900/20">
      <div className="max-w-6xl mx-auto">
        <SectionHeader tag="F" title="TAM / SAM / SOM" subtitle="Derived market models using Goldman Sachs creator data." />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {SOM_SCENARIOS.map(s => (
              <div key={s.creators} className="bg-[#02040f] rounded-lg p-4 text-center border border-cyan-900/10 hover:border-cyan-500/20 transition-all">
                ...
                <p className="text-xl font-black text-white">{s.arr}</p>
                <p className="text-[10px] font-mono text-cyan-400/40">@ {s.arpu}/mo ARR</p>
              </div>
            ))}
          </div>
