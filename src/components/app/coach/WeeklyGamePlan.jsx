...
export default function WeeklyGamePlan({ plan, streams, sessions, profile }) {
    ...
    return (
      <div className="bg-[#060d1f] border border-cyan-900/30 rounded-xl p-5">
        ...
        <div className="text-center py-6">
          ...
          <p className="text-sm font-black uppercase text-slate-400 mb-1">No plan this week</p>
          <p className="text-xs font-mono text-slate-600 mb-4">Schedule streams to build your weekly game plan.</p>
          <Link to="/app/schedule"
            ...
            <Calendar className="w-3 h-3" /> Open Schedule
          </Link>
        </div>
      </div>
    );
