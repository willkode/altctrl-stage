...
import StreamSelector from "../strategy/StreamSelector";
import StrategyCard from "../strategy/StrategyCard";
import ChallengeGenerator from "../strategy/ChallengeGenerator";
import WeeklyPlanView from "../strategy/WeeklyPlanView";
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <h2 className="text-xl font-black uppercase text-white">Strategy</h2>
      </div>

      {/* Tabs */}
      <div className="flex gap-1 bg-[#060d1f] border border-cyan-900/20 rounded-xl p-1">
