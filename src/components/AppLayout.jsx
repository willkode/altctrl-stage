...
import { LayoutDashboard, Calendar, Radio, Brain, Bell, User, Menu, X, Zap, Settings as Settings2Icon, PlayCircle, FlaskConical, ShieldAlert, Crosshair, Swords, HelpCircle, CreditCard } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#02040f] text-white flex flex-col">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 h-16 border-b border-cyan-900/40 bg-[#02040f]/95 backdrop-blur-sm flex items-center px-4 md:px-6 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => setSupportOpen(true)} aria-label="Get Support"
          ...
          {isAdmin && (
            <Link to="/app/admin/dashboard" aria-label="Admin Panel" title="Admin Panel"
